#Crea un programa de venta de periféricos donde debes ingresar los siguientes datos:

#-Ingresar el nombre de usuario que realizará la compra
#-Preguntar si posee un cupón de descuento
#1: Si        0: No
#En caso sea si debe ingresar: TRV125 y se aplicará un 10% de descuento a cada precio
#En caso no posea un cupón los precios seguirán siendo los mismos

#Luego preguntar qué marca de periférico desea:

#L: Logitech. R: Razer. H: Hyperx

#Luego preguntar que periférico desea:

#M: Mouse. T: Teclado. A: Audífonos
...
#Finalmente mostrar una boleta con los siguientes datos:

#Nombre de Usuario
#Fecha: 01/07/2022
#Marca: Marca elegida
#Periférico: Periférico elegido
#Precio: Precio del periférico elegido
