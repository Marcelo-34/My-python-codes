...
while True:
    ...
    if(opcion==0 or opcion>5):
        ...
        print("Rut(Sin puntos ni guion ni digito verificador): ")
        ...
        if(rutPasajero>99999999):
            ...
            print("Telefono(Solo con desde el tercer digito(9) hacia delante): ")
            telefonoPasajero=(int(input()))

            if(telefonoPasajero>999999999):
                ...
                if(asiento>42):
                    ...
                    print()
                    print("No existe un asiento con ese numero")
                    print("Regresando al Menu...")
                    ...
                    if(bancoPasajero=='bancoDuoc'):
                        ...
                        if(op1==1):
                            ...
                            print()
                            print("Regresando al Menu...")
                             #Al momento que se realice la compra el asiento sera tachado con una x 
                             #Para verificar si el asiento esta comprado vuelva a ver la lista de asientos despues de la compra
        ...
        if(rutPasajero==0):
            ...
            if(op1==1):
                ...
                if(rutPasajero1==rutPasajero):
                    ...
                    print("Vuelo anulado")#Al momento de ser anulado el vuelo la x desaparecera del asiento comprado
                    nombrePasajero=0      #Para verificar volver a ver el menu de asientos despues de haber anulado el vuelo
                    rutPasajero=0
                    telefonoPasajero=0
                    bancoPasajero=0
